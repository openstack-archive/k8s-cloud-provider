...
function install_k8s_cloud_provider {
    ...
    # Need PR 45177 above
    export CLUSTER_SIGNING_CERT_FILE=/var/run/kubernetes/client-ca.crt
    export CLUSTER_SIGNING_KEY_FILE=/var/run/kubernetes/client-key.crt
